...
#Daily
Sta_daily_2019 = read.table("Data/Stavoren_daily_2019_revised.txt", sep="\t", header=TRUE)
Sta_daily_2020 = read.table("Data/Stavoren_daily_2020_revised.txt", sep="\t", header=TRUE)

#Hourly
Sta_Hourly_2019 = read.table("Data/Stavoren_hourly_2019_revised.txt", sep="\t", header=TRUE)
Sta_Hourly_2020 = read.table("Data/Stavoren_hourly_2020_revised.txt", sep="\t", header=TRUE)

######Trintelhaven Station (Tri)

#Daily
Tri_daily_2019 = read.table("Data/Trintelhaven_daily_2019_revised.txt", sep="\t", header=TRUE)
Tri_daily_2020 = read.table("Data/Trintelhaven_daily_2020_revised.txt", sep="\t", header=TRUE)

#Hourly
Tri_Hourly_2019 = read.table("Data/Trintelhaven_hourly_2019_revised.txt", sep="\t", header=TRUE)
Tri_Hourly_2020 = read.table("Data/Trintelhaven_hourly_2020_revised.txt", sep="\t", header=TRUE)
...
#######Stavoren Station (Sta)
#Daily
Stra_Ewater_2019 = read.table("Data/Ewater_Stavoren_2019.txt", sep=",", header=TRUE)

Stra_Ewater_2020 = read.table("Data/Ewater_Stavoren_2020.txt", sep=",", header=TRUE)
                              
Tri_Ewater_2019 = read.table("Data/Ewater_Trintelhaven_2019.txt", sep=",", header=TRUE)

Tri_Ewater_2020 = read.table("Data/Ewater_Trintelhaven_2019.txt", sep=",", header=TRUE)                                                        
