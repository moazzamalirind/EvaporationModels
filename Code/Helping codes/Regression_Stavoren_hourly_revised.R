...
# From scripts 'Preproc_datasets_regr_HESS_corrected.R'
summer = read.table("Stavoren_hourly_2019_revised.txt", sep="\t", header=TRUE)
summer_2020 = read.table("Stavoren_hourly_2020_revised.txt", sep="\t", header=TRUE)
...
for(i in c("sums","mult")){
  ...
  # The adjusted r-squared for each model
