...
summer = read.table("Trintelhaven_daily_2019_routine_revised.txt", sep="\t", header=TRUE)
summer_2020 = read.table("Trintelhaven_daily_2020_routine_revised.txt", sep="\t", header=TRUE)
