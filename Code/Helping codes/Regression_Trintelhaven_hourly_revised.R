...
summer = read.table("Trintelhaven_hourly_2019_revised.txt", sep="\t", header=TRUE)
summer_2020 = read.table("Trintelhaven_hourly_2020_revised.txt", sep="\t", header=TRUE)
...
# Calibration done based on the summer of 2019.
# Validation is done based on the summer of 2020.
