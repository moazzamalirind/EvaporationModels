...
##Packages required:
#you might not require all of the following packages but no harm in downloading
...
#### Read data sets 
######################
#Temporal coverage:  summer periods 2019-2020 

#### Variable names:
# LE = latent heat flux (W/m2)
# Kin = global radiation (W/m2)
# u = wind speed (m/s)
# De = vapour pressure gradient (kpa)
# VPD = vapour pressure deficit (kpa)
# Twater = sub-skin water temperature (C)
...
```{r}
#Import data
Summer_Stra_Daily2019 <- read.xlsx("Data_Netherlands.xlsx", sheetName = "Summer_Stra_Daily19")
Summer_Stra_Daily2020 <- read.xlsx("Data_Netherlands.xlsx", sheetName = "Summer_Stra_Daily20")
Summer_Tri_Daily2019 <- read.xlsx("Data_Netherlands.xlsx", sheetName = "Summer_Tri_Daily19")
Summer_Tri_Daily2020 <- read.xlsx("Data_Netherlands.xlsx", sheetName = "Summer_Tri_Daily20")
...
# 1 w/M2 = 1 J/s.m2 = 1 J *86400 / day m2 = 86400*10^-6 MJ/m2 day

Summer_Stra_Daily2019$LE_MJ <- Summer_Stra_Daily2019$LE * (86400*10^-6)
Summer_Stra_Daily2020$LE_MJ <- Summer_Stra_Daily2020$LE * (86400*10^-6)
Summer_Tri_Daily2019$LE_MJ <- Summer_Tri_Daily2019$LE * (86400*10^-6)
Summer_Tri_Daily2020$LE_MJ <- Summer_Tri_Daily2020$LE * (86400*10^-6)

#Evaporation Estimate 
Stra_Eobs_daily2019 <-data.frame(Date= Summer_Stra_Daily2019$Date,
                                  Evap_obs=Summer_Stra_Daily2019$LE_MJ/Lv)

Stra_Eobs_daily2020 <-data.frame(Date= Summer_Stra_Daily2020$Date,
                                  Evap_obs=Summer_Stra_Daily2020$LE_MJ/Lv)  
  
Tri_Eobs_daily2019 <-data.frame(Date= Summer_Tri_Daily2019$Date,
                                  Evap_obs=Summer_Tri_Daily2019$LE_MJ/Lv)

Tri_Eobs_daily2020 <-data.frame(Date= Summer_Tri_Daily2020$Date,
                                  Evap_obs=Summer_Tri_Daily2020$LE_MJ/Lv)  
